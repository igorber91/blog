...
<?php 
$peticion1="select idpost from usuario_post where idusuario not like  3";


$resul1=mysqli_query($conexion,$peticion1);

while($fila2=mysqli_fetch_array($resul1)){
$idpost2=$fila2['idpost'];

$peticion2="select * from post where idpost=".$idpost2."";
$resul2=mysqli_query($conexion,$peticion2);
while($fila1=mysqli_fetch_array($resul2)) {
